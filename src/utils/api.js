...
function getTmdbLanguage() {
  try {
    const raw = localStorage.getItem("jetflix_tmdbLang");
...
export function clearTmdbCache() {
  _tmdbCache.clear();
  try {
    localStorage.removeItem("jetflix_trendingCache");
  } catch {}
}
...
const ANILIST_CACHE_KEY = "jetflix_anilistCache";
...
const EG_CACHE_KEY = "jetflix_episodeGroupCache";
