...
export const storage = {
  ...
  // Remove all jetflix_ keys (used by reset)
  clearAll() {
    try {
...
export async function clearAppCaches() {
  ...
  localStorage.removeItem("jetflix_anilistCache");
  localStorage.removeItem("jetflix_episodeGroupCache");
  localStorage.removeItem("jetflix_aniskipCache");
