...
function BackupRestoreSection({ onRestored }) {
  ...
  const handleExport = () => {
    ...
    a.href = url;
    a.download = `jetflix-backup-${new Date().toISOString().slice(0, 10)}.json`;
    a.click();
...
function AppearanceSection() {
  ...
  const handleSave = () => {
    ...
    window.dispatchEvent(new CustomEvent("jetflix:player-settings-changed"));
    setSaved(true);
    setTimeout(() => setSaved(false), 2000);
  };
...
function LibraryPrivacySection() {
  ...
  const handleSave = () => {
    ...
    window.dispatchEvent(
      new CustomEvent("jetflix:library-sort-changed", { detail: sort }),
    );
    setSaved(true);
    setTimeout(() => setSaved(false), 2000);
  };
...
function StartPageSection() {
  ...
  return (
    <div style={{ marginBottom: 40 }}>
      ...
      >
        Choose which page opens when you launch Jetflix.
      </div>
      <div
        style={{
          display: "flex",
...
function TmdbLanguageSection() {
  ...
  const handleSave = () => {
    ...
    window.dispatchEvent(new CustomEvent("jetflix:tmdb-lang-changed"));
    setSaved(true);
    setTimeout(() => setSaved(false), 2000);
  };
      ...
      {enabled && (
        <>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            >
              Required for Wyzie Subs. Enter the API key issued by that service.
            </div>
            <div
              style={{
                display: "flex",
...
function DiscordRpcSection() {
  ...
  const saveSettings = () => {
    ...
    window.dispatchEvent(
      new CustomEvent("jetflix:discord-rpc-settings-changed"),
    );
    setSaved(true);
    setTimeout(() => setSaved(false), 2000);
  };
    ...
    <div style={{ marginBottom: 40 }}>
      ...
      >
        ...
        <ToggleRow
          ...
          description="Uses the movie/show poster as the large image. When off, only the Jetflix icon is shown."
          value={showCover}
    ...
    <>
      ...
      {showDeleteDlConfirm && (
        <ConfirmDialog
          ...
          description="This will permanently delete all video files downloaded through Jetflix and remove them from the download list."
        ...
        <div ref={secDownloads} style={{ scrollMarginTop: 80 }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            >
              ...
              and Jetflix has write access to it.
            </div>
            <div
              style={{
                display: "flex",
          ...
          >
            ...
            <div style={{ padding: "22px 24px" }}>
              <CleanRow
                ...
                description="Opens the folder where Jetflix is installed."
            ...
            <div style={{ padding: "22px 24px" }}>
              <CleanRow
                title="Delete All Downloads"
                description="Permanently deletes all video files that were downloaded through Jetflix and removes them from the download list. Only files downloaded through the app will be deleted, nothing else in your folder is touched."
            ...
            >
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  >
                    Completely resets Jetflix to factory defaults, clears all
